...
public interface IEventService
{
    ...
    Task<Result<EventResponse>> GetPublishedEventAsync(Guid eventId, CancellationToken cancellationToken = default);
    Task<Result<List<EventResponse>>> GetEventsByOrganizerAsync(Guid organizerId, CancellationToken cancellationToken = default);
    Task<Result<List<EventResponse>>> SearchPublishedEventsAsync(SearchPublishedEventsRequest request, CancellationToken cancellationToken = default);
    ...
    Task<Result> CompleteEventAsync(Guid organizerId, Guid eventId, CancellationToken cancellationToken = default);
}
